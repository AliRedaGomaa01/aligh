...
<main class="container mx-auto p-5 flex-1 flex flex-col items-center justify-center gap-10">
  ...
  $parentSectionClasses = "grid grid-cols-1 gap-5 md:gap-10 mx-auto shadow-[-3px_-3px_3px_0px_rgb(0,0,0,0.5),3px_3px_3px_0px_rgb(0,0,0,0.5)] p-5 sm:p-10 leading-8 rounded-xl w-full max-w-[1000px] ";
